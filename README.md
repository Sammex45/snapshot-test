...
Set these before running SmartUI flows (via terminal, `.env`, or the provided scripts):
...
> The `run-smartui-tests.bat` and `run-smartui-tests.ps1` scripts show concrete examples of exporting these values.
